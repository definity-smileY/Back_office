...
# Build paths inside the project like this: BASE_DIR / 'subdir'.t.com/en/3.1/howto/deployment/checklist/
...
BATON = {
    ...
    'SITE_TITLE' : '백오피스',
    'INDEX_TITLE' : '관리자페이지',
    'SUPPORT_HREF' : 'https://blog.naver.com/yysdntjq/222118316719',
    # 'SUPPORT_HREF' : 'mailto:yysdntjq@naver.com',
    'COPYRIGHT' : 'copyright © 2020 dbsdntjq',
    'POWERED_BY' : '<a href="https://blog.naver.com/yysdntjq">윤우섭 블로그</a>',
    'MENU_TITLE' : '윤우섭',
    'MENU': (
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True, #각 앱들안에있는 템플릿폴더경로를 찾아보게 허용하는것
        'OPTIONS': {
            'context_processors': [
